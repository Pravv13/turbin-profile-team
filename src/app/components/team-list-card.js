...
import { Pagination, Autoplay, A11y, EffectCoverflow, Navigation } from "swiper/modules";
    ...
    async function fetchData() {
      try {
        const response = await fetch(
          "https://cdn.contentful.com/spaces/ludm34z2ea2p/environments/master/entries?content_type=employee&access_token=AF_GWc-R5hYt7UQ5QxJxEgyuZ3glIw4MD-rTJ7J9s18", {next: {revalidate: 10}}
        );
        if (response.ok) {
          ...
          for (const employee of employeesData) {
            ...
            const assetResponse = await fetch(
              `https://cdn.contentful.com/spaces/ludm34z2ea2p/environments/master/assets/${assetId}?access_token=AF_GWc-R5hYt7UQ5QxJxEgyuZ3glIw4MD-rTJ7J9s18`, {next: {revalidate: 10}}
            );
                ...
                <div className={style.shape}>
                  ...
                  <div className={style.content}>
                    <div className="font-mono font-bold text-[25px]">
                      ...
                      <h1 className="font-mono font-bold text-[20px] text-[#D0E7D2]">{employee.fields.position}</h1><br></br>
                      <div className="flex justify-center items-center gap-4">
                        ...
                        <a href={employee.fields.gmail}>
                         <svg fill="#ffffff" width="32px" height="32px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"></path></g></svg>
                        </a>
